...
<div x-data="dashboard">
    <div class="flex flex-col min-h-[calc(100vh-100px)] justify-between mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div class="flex flex-col items-start w-full space-y-2">
            ...
            <x-primary-button class="inline-flex flex-row items-center gap-2" 
                @click="generateReport()">
                Gerar relatorio
                <svg x-show="loading" class="w-5 h-5 -ml-1 dark:text-gray-700 animate-spin" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
